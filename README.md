...
What does PRQL stand for? well it sounds like a `prequel` to `sequel` but could mean anything, I thought of **P**artially **R**igorous **Q**uery **L**anguage, but I am looking for open to better names :) 
